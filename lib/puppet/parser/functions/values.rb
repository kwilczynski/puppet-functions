...
Returns an array type that includes all the values from the hash given.
...
For example:
  ...
  The result will be as follows:
    ...
    notice: Scope(Class[main]): 123 456
    EOS
  ) do |*arguments|
    ...
    raise Puppet::ParseError, 'values(): Requires a hash type ' +
